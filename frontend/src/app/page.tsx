...
import { ArrowDown, Instagram, Facebook, Phone, Mail, Play, Pause } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden lg:flex space-x-12 items-center">
              {['About', 'Showroom', 'AI Showroom', 'Collections', 'Services', 'Visit Us'].map((item) => (
                <a
                  key={item}
                  href={item === 'AI Showroom' ? '/smart-showroom' : `#${item.toLowerCase().replace(' ', '')}`}
              ...
              <a
                href="#booking"
                className="bg-charcoal text-white px-6 py-2.5 rounded-sm text-sm font-bold tracking-wider hover:bg-gold transition-colors uppercase"
              >
                BOOK STYLING
              </a>
            </div>
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-16 max-w-4xl mx-auto border-t border-white/10 pt-16">
                <div className="flex flex-col items-center gap-6 group cursor-pointer">
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-3xl font-serif text-white">+91 98765 43210</span>
                  </div>
                </div>
                <div className="flex flex-col items-center gap-6 group cursor-pointer">
                  <div className="w-20 h-20 bg-white/5 rounded-full flex items-center justify-center border border-white/10 group-hover:border-gold group-hover:bg-gold/10 transition-all duration-500">
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-3xl font-serif text-white">hello@rkf.com</span>
                  </div>
                </div>
          </div>
        </div>
      ...
      <footer className="py-20 bg-black text-white/40 border-t border-white/5">
        <div className="container-premium">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-5 text-sm uppercase tracking-widest font-medium">
                ...
                <li><a href="#visit" className="hover:text-gold transition-colors">Flagship Store</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8">
            <p className="text-xs tracking-widest">© {new Date().getFullYear()} RK FURNISHINGS CO. ALL RIGHTS RESERVED - BY ARTISANS FOR ARTISANS.</p>
